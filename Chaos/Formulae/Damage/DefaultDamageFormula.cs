...
public class DefaultDamageFormula : IDamageFormula
{
    protected virtual ImmutableArray<ImmutableArray<decimal>> ElementalModifierLookup { get; } = new[]
    {
        ...
        /* O    Fire*/     new[] { 1.15m, 1.00m, 0.67m,  1.33m, 1.00m, 0.93m, 0.83m,     2.01m, 0.83m,  2.01m }.ToImmutableArray(),
        /* F    Water*/    new[] { 1.15m, 1.33m, 1.00m,  1.00m, 0.67m, 0.93m, 0.83m,     0.58m, 1.74m,  0.93m }.ToImmutableArray(), 
        /* F    Wind*/     new[] { 1.15m, 0.67m, 1.00m,  1.00m, 1.33m, 0.93m, 0.83m,     1.03m, 1.74m,  0.83m }.ToImmutableArray(),
        /* E    Earth*/    new[] { 1.15m, 1.00m, 1.33m,  0.67m, 1.00m, 0.93m, 0.83m,     0.58m, 0.83m,  0.58m }.ToImmutableArray(),
        /* N    Holy*/     new[] { 2.32m, 0.76m, 0.76m,  0.76m, 0.76m, 0.58m, 1.48m,     0.58m, 0.76m,  2.01m }.ToImmutableArray(),
        /* S    Darkness*/ new[] { 2.32m, 1.20m, 1.20m,  1.20m, 1.20m, 1.48m, 0.58m,     1.48m, 0.58m,  0.58m }.ToImmutableArray(),
