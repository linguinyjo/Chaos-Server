...
public class HateAura2Effect : ContinuousAnimationEffectBase,
    ...
    NonOverwritableEffectComponent.INonOverwritableEffectComponentOptions
{
    ...
    public int? ExclusionRange { get; init; } = 0;
    ...
    /// <inheritdoc />
    public override string Name => "Aura of Hate";
    ...
    public int Enmity { get; init; } = 1000;
