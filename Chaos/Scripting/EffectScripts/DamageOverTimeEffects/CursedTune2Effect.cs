...
/// </summary>
public sealed class CursedTune2Effect : ContinuousAnimationEffectBase,
                                        INonOverwritableEffectComponentOptions,
                                        DamageAbilityComponent.IDamageComponentOptions,
                                        GetTargetsAbilityComponent<Creature>.IGetTargetsComponentOptions
{
    public CursedTune2Effect()
    {
        ApplyDamageScript = ApplyAttackDamageScript.Create(); 
        SourceScript = this;
        AbilityTemplateKey = "cursed_tune_2";
    }
    ...
    public int? BaseDamage { get; init; } = 100;
    public Stat? DamageStat { get; init; } = Stat.INT;
    public decimal? DamageStatMultiplier { get; init; } = 5;
