...
public class IdentifyScript : SpellScriptBase
{
    ...
    private static string FormatItemDetails(Item item)
    {
        ...
        {
            var patk = FormatColor("Physical Atk: ", MessageColor.Silver) +
                       FormatColor($"{item.Modifiers.PhysicalAttack}", MessageColor.White);
            var matk = FormatColor("Magic Atk: ", MessageColor.Silver) +
                       FormatColor($"{item.Modifiers.MagicAttack}", MessageColor.White);
            lines.Add($"{patk}  {matk}");
        }
        ...
        {
            "",
            FormatColor("Health: ", MessageColor.Silver) +
            FormatColor($"{item.Modifiers.MaximumHp}", MessageColor.White) +
            "  " +
            ...
            "  " +
            FormatColor("MR: ", MessageColor.Silver) +
            FormatColor($"{item.Modifiers.MagicResistance}", MessageColor.White) +
            "  " +
            ...
            "  " +
            FormatColor("Durability: ", MessageColor.Silver) +
            FormatColor($"{item.Template.MaxDurability}", MessageColor.White) +
            "  " +
