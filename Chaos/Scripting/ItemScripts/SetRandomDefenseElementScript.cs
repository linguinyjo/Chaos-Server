...
public class SetRandomDefenseElementScript : ItemScriptBase
{
    /// <inheritdoc />
    ...
    public override void OnDropped(Creature source, MapInstance mapInstance)
    {
        ...
        {
            case Element.Fire:
                Subject.AddScript<FireDefensePrefixScript>();
                break;
            case Element.Water:
                Subject.AddScript<SeaDefensePrefixScript>();
                break;
            case Element.Wind:
                Subject.AddScript<WindDefensePrefixScript>();
                break;
            case Element.Earth:
                Subject.AddScript<EarthDefensePrefixScript>();
                break;
        }
    }
}
