...
public static class PointExtensions
{
    ...
    /// </remarks>
    public static IEnumerable<Point> ConalSearch<T>(this T point, Direction direction, int maxDistance) where T: IPoint, allows ref struct
    {
    ...
    public static Point DirectionalOffset<T>(this T point, Direction direction, int distance = 1) where T: IPoint, allows ref struct
    {
        if (direction == Direction.Invalid)
    ...
    /// </returns>
    public static Direction DirectionalRelationTo<T1, T2>(this T1 point, T2 other) where T1: IPoint, allows ref struct
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double EuclideanDistanceFrom<T1, T2>(this T1 point, T2 other) where T1: IPoint, allows ref struct
                                                                                where T2: IPoint, allows ref struct
    {
    ...
    /// </summary>
    public static T FindCenterMost<T>(this ICollection<T> points) where T: IPoint
    {
    ...
    /// </code>
    /// </example>
    public static IEnumerable<Point> GenerateCardinalPoints<T>(this T start, Direction direction = Direction.All, int radius = 1)
        where T: IPoint, allows ref struct
    {
    ...
    /// </code>
    /// </example>
    public static IEnumerable<Point> GenerateIntercardinalPoints<T>(this T start, Direction direction = Direction.All, int radius = 1)
        where T: IPoint, allows ref struct
    {
        var x = start.X;
        var y = start.Y;
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsInterCardinalTo<T1, T2>(this T1 point, T2 other, Direction direction) where T1: IPoint, allows ref struct
        where T2: IPoint, allows ref struct
    {
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int ManhattanDistanceFrom<T1, T2>(this T1 point, T2 other) where T1: IPoint, allows ref struct
                                                                             where T2: IPoint, allows ref struct
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Point OffsetTowards<T1, T2>(this T1 point, T2 other) where T1: IPoint, allows ref struct
                                                                       where T2: IPoint, allows ref struct
    {
    ...
    ///     <br />
    /// </remarks>
    public static IEnumerable<Point> RayTraceTo<T1, T2>(this T1 start, T2 end) where T1: IPoint, allows ref struct
                                                                               where T2: IPoint, allows ref struct
    {
        var x0 = start.X;
        var y0 = start.Y;
    ...
    /// </remarks>
    public static IEnumerable<Point> SpiralSearch<T>(this T point, int maxRadius = byte.MaxValue) where T: IPoint, allows ref struct
    {
        var x = point.X;
        var y = point.Y;
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<T> WithConsistentDirectionBias<T>(this IEnumerable<T> points, Direction direction) where T: IPoint
    {
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<T> WithDirectionBias<T>(this IEnumerable<T> points, Direction direction) where T: IPoint
    {
        ArgumentNullException.ThrowIfNull(points);
