...
public sealed class EnumerableExtensionsTests
{
    ...
    #region Additional TakeRandom Tests
    [Test]
    public void TakeRandom_Should_Return_Empty_When_Count_Is_Zero()
    {
        // Arrange
        var enumerable = new[]
        {
        ...
        // Act
        var result = enumerable.TakeRandom(COUNT)
                               .ToArray();
    ...
    [Test]
    public void TakeRandom_Should_Handle_Empty_Enumerable()
    {
        // Arrange
        var enumerable = Enumerable.Empty<int>();
        const int COUNT = 5;
    ...
    [Test]
    public void TakeRandom_Should_Handle_Single_Item_Collection()
    {
        // Arrange
        var enumerable = new[]
        {
    ...
    [Test]
    public void TakeRandom_Should_Return_Subset_Of_Original_Collection()
    {
        // Arrange
        var enumerable = new[]
        {
        ...
        result.Should()
              .HaveCount(COUNT)
              .And
              .OnlyContain(item => enumerable.Contains(item));
    }

    [Test]
    public void TakeRandom_Should_Maintain_Original_Order_Of_Selected_Items()
    {
        // Arrange - create a large enough collection to make this test meaningful
        ...
        for (var i = 0; i < 10; i++)
        {
            ...
            // Assert - the selected items should maintain their original relative order
            result.Should()
                  .BeInAscendingOrder("because TakeRandom should preserve the original order of selected items");
        }
    }
    #endregion
}