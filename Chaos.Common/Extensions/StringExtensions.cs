...
public static class StringExtensions
{
    ...
    extension(string str1)
    {
        ...
        /// </returns>
        public int CalculateLevenshteinDistance(string str2, bool caseSensitive = false)
        {
        ...
        /// </returns>
        public decimal CalculateSorensenCoefficient(string string2, bool caseSensitive = false)
        {
            if (string.IsNullOrEmpty(str1) || string.IsNullOrEmpty(string2))
                return 0m;

            var span1 = str1.AsSpan();
            var span2 = string2.AsSpan();
            var intersections = 0;
            var totalBigrams = str1.Length + string2.Length - 2;
        ...
        /// </param>
        public string CenterAlign(int width)
        {
        ...
        ///     </c>
        /// </returns>
        public bool ContainsI(string str2) => str1.Contains(str2, StringComparison.OrdinalIgnoreCase);
        ...
        ///     </c>
        /// </returns>
        public bool EndsWithI(string str2) => str1.EndsWith(str2, StringComparison.OrdinalIgnoreCase);
        ...
        ///     </c>
        /// </returns>
        public bool EqualsI(string str2) => str1.Equals(str2, StringComparison.OrdinalIgnoreCase);
        ...
        public string FirstUpper()
        {
            ...
            return str1 switch
            {
                "" => throw new ArgumentException($"{nameof(str1)} cannot be empty", nameof(str1)),
                _  => string.Concat(char.ToUpper(str1[0]), str1[1..])
            };
        }
        ...
        /// </summary>
        public string FixLineEndings()
            => str1.ReplaceLineEndings("\n")
                   .TrimEnd('\n');
    }
            ...
            bool caseSensitive = false)
        {
            try
            {
                ...
                var possibleMatches = strings.Select(s => (String: s, Coefficient: s.CalculateSorensenCoefficient(str, caseSensitive)))
                                             ...
                                             .Select(x => (x.String, x.Coefficient,
    ...
    extension(string str1)
    {
        ...
        /// </returns>
        public string ReplaceI(string oldValue, string newValue) => str1.Replace(oldValue, newValue, StringComparison.OrdinalIgnoreCase);
        ...
        ///     </c>
        /// </returns>
        public bool StartsWithI(string str2) => str1.StartsWith(str2, StringComparison.OrdinalIgnoreCase);
    }
}